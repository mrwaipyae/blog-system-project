    ...
    <section class="bg-light mt-5">
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-md-7">
                    <h1 class="display-4 fw-bold mb-4">A place to share knowledge and better understand the world</h1>
                    <p class="lead mb-4">Sign up to read and write thoughtful stories and essays on topics that matter
                    </p>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="mb-2 text-muted">by <a href="#">John Doe</a> in <a href="#">Technology</a></div>
                            <h5 class="card-title mb-3">How to Build a Website from Scratch</h5>
                            <div class="mb-2"><small class="text-muted">May 4</small></div>
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam gravida
                ...
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="mb-2 text-muted">by <a href="#">Jane Smith</a> in <a href="#">Culture</a></div>
                ...
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="mb-2 text-muted">by <a href="#">David Lee</a> in <a href="#">Business</a></div>
